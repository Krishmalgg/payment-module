...
namespace PaymentModule.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260207112056_AddRefundAndDLQTables")]
    partial class AddRefundAndDLQTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PaymentModule.Domain.Entities.Refund", b =>
                {
                    ...
                    b.HasIndex("TransactionRef")
                        .IsUnique()
                        .HasDatabaseName("idx_refunds_transaction_ref");
            ...
            modelBuilder.Entity("PaymentModule.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasIndex("TransactionRef")
                        .IsUnique()
                        .HasDatabaseName("idx_transactions_transaction_ref");
