...
namespace PaymentModule.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260302090000_Outbox_AddScalableProcessingColumns")]
    partial class Outbox_AddScalableProcessingColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PaymentModule.Domain.Entities.DeadLetterQueue", b =>
                {
                    ...
                    b.Property<string>("SourceQueue")
                        ...
                        .HasColumnName("SourceQueue");

                    b.HasKey("Id");

                    b.HasIndex("MessageType")
                        .HasDatabaseName("idx_dlq_message_type");
